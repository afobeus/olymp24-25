...
TEST_CASES = [(TestCase((1, 10), (1, 10), (0, 10)), 5),
              (TestCase((10, 100), (1, 100), (0, 100)), 10),
              (TestCase((10, 100), (100, 10 ** 5), (100, 10 ** 5)), 10),
              (TestCase((10, 100), (10 ** 5, 10 ** 9), (10 ** 5, 10 ** 9)), 10),
              (TestCase((100, 10 ** 3), (10 ** 5, 10 ** 9), (10 ** 5, 10 ** 9)), 10),
              (TestCase((10 ** 3 - 100, 10 ** 3), (1, 10 ** 9), (0, 10 ** 9)), 3)]
